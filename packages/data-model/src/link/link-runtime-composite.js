...
export const definition = {
  ...
  "objects": {
    "Vote": {
      ...
      "revoke": { "type": "boolean", "required": false, indexed: true },
      "createAt": { "type": "datetime", "required": false, indexed: true },
      "modifiedAt": { "type": "datetime", "required": false, indexed: true },
      "link": {
        "type": "view",
        "viewType": "relation",
        "relation": {
    ...
    "Comment": {
      "text": { "type": "string", "required": true, indexed: true },
      "linkID": { "type": "streamid", "required": true },
      "revoke": { "type": "boolean", "required": false, indexed: true },
      "createAt": { "type": "datetime", "required": false, indexed: true },
      "modifiedAt": { "type": "datetime", "required": false, indexed: true },
    ...
    "Link": {
      "url": { "type": "uri", "required": true, indexed: true },
    ...
    "Score": {
      "text": { "type": "string", "required": true, indexed: true },
      "value": { "type": "integer", "required": true, indexed: true },
      "linkID": { "type": "streamid", "required": true },
      "revoke": { "type": "boolean", "required": false, indexed: true },
      "createAt": { "type": "datetime", "required": false, indexed: true },
      "modifiedAt": { "type": "datetime", "required": false, indexed: true },
