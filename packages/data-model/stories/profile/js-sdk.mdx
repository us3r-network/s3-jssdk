...
Before using the SDK, you need to create a Ceramic instance and pass it to the SDK. And you need to create a [DID Session](https://developers.ceramic.network/reference/accounts/did-session/) and pass it to the SDK for the write
